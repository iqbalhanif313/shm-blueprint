...
with open(output_file, mode='a', newline='') as csv_file:
    ...
    if not file_exists:
        csv_writer.writerow(['TIMESTAMP', 'SG_SENSOR', 'SG_DATA', 'SG_STATUS','VIBRATION_DATA','TEMPERATURE_DATA','FOG_PRESENCE_DATA','WEATHER_ALERT_DATA' ])  # Modify these headers based on your schema
