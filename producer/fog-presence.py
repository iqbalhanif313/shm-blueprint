...
def produce_message(topic, message):
    ...
    if topic in data_to_read:
        print(message)
        producer.produce(topic="fog-presence",key="fog_presence_data_"+topic,  value=message, on_delivery=delivery_report)
    producer.poll(0)
