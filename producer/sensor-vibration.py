...
def produce_message(topic, message):
    ...
    if topic in data_to_read:
        print(message)
        producer.produce(topic="sensor-vibration",key="vibration_data_"+topic,  value=message, on_delivery=delivery_report)
    producer.poll(0)
