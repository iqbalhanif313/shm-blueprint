...
def produce_message(topic, message):
    ...
    print(topic)
    if topic in data_to_read:
        print(message)
        producer.produce(topic="weather-alert",key="weather_alert_data_"+topic,  value=message, on_delivery=delivery_report)
    producer.poll(0)
...
folder_path = '../data/weather-alert'
